...
// Generated from: uk.ac.stand.cs.insense.compiler.unixCCgen.DeclarationContainer::locationInitialisers
	DAL_assign( &this->s_comp,component_create( Construct_Sender0, sizeof( SenderStruct ) , 46, 0, NULL )  ) ;
	DAL_assign( &this->r_comp,component_create( Construct_Receiver0, sizeof( ReceiverStruct ) , 40, 0, NULL )  ) ;
