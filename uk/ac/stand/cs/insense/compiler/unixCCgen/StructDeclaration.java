...
public abstract class StructDeclaration extends Code implements IStructDeclaration {
	 ...
	 * @see uk.ac.stand.cs.insense.compiler.unixCCgen.Code#complete()
	 */
	...
	private String generateCopyFunction() {
		...
		sb.append( TAB + struct_pntr_name() + "copy" + SPACE + EQUALS_ + constructorName() + LRB + SPACE + copyFunctionConstructorArguments() + SPACE + RRB + SEMI + NEWLINE);
